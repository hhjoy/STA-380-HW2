...
```
Naive Bayes only acheives an accuracy of 49% which is not very good. Jim Gilchrist and Fumiko Fujisaki are predicted best, while authors like John Mastrini are predicted poorly.
